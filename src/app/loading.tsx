      ...
      <main className="flex-grow w-full px-6 sm:px-10 md:px-14 lg:px-16 xl:px-20 max-w-[1600px] mx-auto pt-8 pb-16 md:pt-14 md:pb-24 lg:pt-16 lg:pb-28 space-y-24 md:space-y-32 lg:space-y-40 animate-pulse">
        ...
        <section>
          ...
          <div className="space-y-4 py-2">
            <div className="h-9 bg-surface-container-highest rounded-lg w-full"></div>
            <div className="h-9 bg-surface-container-highest rounded-lg w-5/6"></div>
            <div className="h-9 bg-surface-container-highest rounded-lg w-full"></div>
            <div className="h-9 bg-surface-container-highest rounded-lg w-4/5"></div>
          </div>
        </section>
